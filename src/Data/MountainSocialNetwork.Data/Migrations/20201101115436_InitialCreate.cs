    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavouriteArticles", x => new { x.UserId, x.ArticleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserFavouriteArticles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavouriteArticles_ArticleId",
                table: "UserFavouriteArticles",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFavouriteArticles_IsDeleted",
                table: "UserFavouriteArticles",
                column: "IsDeleted");
        }
