...
namespace MountainSocialNetwork.Data.Migrations
{
    ...
    [Migration("20201212172012_AddModelsFriendAndFriendRequest")]
    partial class AddModelsFriendAndFriendRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MountainSocialNetwork.Data.Models.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MountainSocialNetwork.Data.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MountainSocialNetwork.Data.Models.Friend", b =>
                {
                    b.HasOne("MountainSocialNetwork.Data.Models.ApplicationUser", "Receiver")
                        .WithMany("Friends")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MountainSocialNetwork.Data.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("MountainSocialNetwork.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("FriendRequestSend");
